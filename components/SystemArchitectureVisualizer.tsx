...
const nodes: NodeDef[] = [
    ...
    { id: 'actionset', label: 'SECActionSetComponent', friendlyLabel: 'Movelist holder', shortLabel: 'ActionSetComp', icon: Zap, color: 'green', side: 'pawn', simpleBox: 'pawn', description: 'Pawn-side action sets — resolution + replication.', details: ['Resolution: Override → Provided → Config Role → Default → Component → null', 'Replicates CurrentActionId, bActionExecuting, ActiveActionSet', 'Inject: SetRuntimeOverride(), SetProvidedActionSet()'] },
    { id: 'reactionset', label: 'SECReactionSetComponent', friendlyLabel: 'Reaction list', shortLabel: 'ReactionSetComp', icon: Shield, color: 'purple', side: 'pawn', simpleBox: 'pawn', description: 'Pawn-side reaction sets — mirrors ActionSet pattern.', details: ['Resolution: Override → Provided → Config Role → Default → Component → null', 'Replicates CurrentReactionId, bReactionExecuting, ActiveReactionSet', 'Swap: Immediate or WaitForCompletion'] },
