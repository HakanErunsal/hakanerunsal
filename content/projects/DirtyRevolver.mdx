...
<div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginTop: '24px', marginBottom: '40px', flexWrap: 'wrap' }}>
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(128, 128, 128, 0.1)', borderRadius: '12px', border: '1px solid rgba(128, 128, 128, 0.3)' }}>
    ...
    <a href="https://play.google.com/store/apps/details?id=com.Dreambox.RustyRevolver" target="_blank" rel="noopener noreferrer" style={{ display: 'block', padding: '12px 24px', backgroundColor: '#34a853', color: '#fff', textDecoration: 'none', borderRadius: '8px', fontWeight: '600', textAlign: 'center', fontSize: '14px' }}>
      Google Play
    </a>
  </div>
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(128, 128, 128, 0.1)', borderRadius: '12px', border: '1px solid rgba(128, 128, 128, 0.3)' }}>
