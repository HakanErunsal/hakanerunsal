...
<div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginTop: '24px', marginBottom: '40px', flexWrap: 'wrap' }}>
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(128, 128, 128, 0.1)', borderRadius: '12px', border: '1px solid rgba(128, 128, 128, 0.3)' }}>
    ...
    <a href="https://play.google.com/store/apps/details?id=com.Dreambox.RustyRevolver" target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center' }}>
  ...
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(128, 128, 128, 0.1)', borderRadius: '12px', border: '1px solid rgba(128, 128, 128, 0.3)' }}>
    ...
    <a href="https://apps.apple.com/us/app/dirty-revolver-cowboy-shooter/id1531079942" target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center' }}>
