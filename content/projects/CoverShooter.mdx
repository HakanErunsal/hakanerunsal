...
<img src="../images/covershooter_header_badge.png" alt="Game Image" className="w-full h-auto" />
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', marginTop: '20px' }}>
  <div style={{ width: '250px', textAlign: 'left', marginRight: '40px', minHeight: '200px' }}>
    ...
    <div style={{ textAlign: 'center', marginTop: '10px' }}>
      <a href='https://play.google.com/store/apps/details?id=com.rigbakgames.covershooter3d&hl=en&gl=US' target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block' }}>
...
<ZoomableImage
src="../images/covershooter_screenshot1.png"
/>

<ZoomableImage
src="../images/covershooter_screenshot2.png"
/>

<ZoomableImage
src="../images/covershooter_screenshot3.png"
/>