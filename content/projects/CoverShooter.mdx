...
<div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginTop: '24px', marginBottom: '40px', flexWrap: 'wrap' }}>
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(52, 168, 83, 0.1)', borderRadius: '12px', border: '1px solid rgba(52, 168, 83, 0.3)' }}>
    ...
    <a href='https://play.google.com/store/apps/details?id=com.rigbakgames.covershooter3d' target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center' }}>
  ...
  <div style={{ width: '280px', padding: '24px', backgroundColor: 'rgba(0, 122, 255, 0.1)', borderRadius: '12px', border: '1px solid rgba(0, 122, 255, 0.3)' }}>
    ...
    <a href="https://apps.apple.com/us/app/cover-shooter-free-fire-games/id1505399592" target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center' }}>
      <img src="../images/appstore-download-badge.svg" alt="Download on the App Store" style={{ width: '210px', maxWidth: '100%', height: 'auto', display: 'block', margin: '0 auto' }} />
    </a>
  </div>
</div>
