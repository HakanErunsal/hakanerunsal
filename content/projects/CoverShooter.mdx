    ...
    <ul>
      ...
      <li>Reviews: 829</li>
        <a href='https://play.google.com/store/apps/details?id=com.rigbakgames.covershooter3d' target="_blank" rel="noopener noreferrer">
          <img alt='Get it on Google Play' src='./../images/googleplay-download-badge.png' style={{ width: '200px', marginTop: '10px' }}/>
        </a>
    </ul>
  </div>
  <div>
    ...
    <ul>
      ...
      <li>Reviews: 750</li>
        <a href="https://apps.apple.com/us/app/cover-shooter-free-fire-games/id1505399592" target="_blank" rel="noopener noreferrer">
          <img alt='Download on the App Store' src='./../images/appstore-download-badge.svg' style={{ width: '200px', marginTop: '10px' }}/>
        </a>
    </ul>
  </div>
</div>
