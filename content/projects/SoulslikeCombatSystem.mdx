...
A **production-ready AI combat system** for Unreal Engine 5.6+. Built for souls-like and action RPG games, this plugin provides intelligent enemy behavior, tactical movement, and scalable combat AI without the complexity of building from scratch.
...
3. **Open the demo level** (`LVL_SEC_Showcase`) to see a working enemy
