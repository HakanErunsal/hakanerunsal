---
title: "Weapons"
description: "Give an enemy a weapon from a loadout, with its own moveset, reactions and trace sockets."
date: 2026-07-31
published: true
...
> Fill in a loadout entry and the enemy spawns holding its weapon, sockets registered, animation layer linked, and the weapon's own moveset and reactions in force.
