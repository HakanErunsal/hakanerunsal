...
<Collapsible title="Changing one phase of the pipeline" badge="Advanced">
...
<Collapsible title="Opening a trace window without a montage notify" badge="Alternative">
...
| [API Reference](/docs/soulslike-combat/api-reference#usecmeleetracecomponent) | The override points and the hit payloads in C++. |
