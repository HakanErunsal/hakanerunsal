...
<UeSetPropertiesScene
  ...
  section="Behavior"
  rows={[
    { name: "Default State Tree", value: "StateTree_SEC_Core", kind: "asset", thumb: "tree", accent: "#C9B91D" }
  ]}
...
<DocNav
  ...
  next={{ title: "Core Architecture", href: "/docs/soulslike-combat/architecture" }}
/>
