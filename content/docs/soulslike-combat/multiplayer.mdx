...
1. **Register combat targets.** In multiplayer, register each player pawn as a combat target. The [Targeting System](/docs/soulslike-combat/targeting-system) handles multi-target distribution.
