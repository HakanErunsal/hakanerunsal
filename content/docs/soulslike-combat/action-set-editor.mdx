...
- **Chain Only** set on a card nothing wires into, which leaves automatic selection no way to reach it.
- **Manual Only** and **Chain Only** both set, where Manual Only wins and Chain Only adds nothing.
