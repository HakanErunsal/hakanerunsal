...
| `CustomScoring` | `FSECCustomScoring` | Custom scorers scale the selection weight, gates allow or deny. See [Custom Scorers & Gates](/docs/soulslike-combat/action-system#custom-scorers--gates). |
