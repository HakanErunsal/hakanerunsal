...
Provided set and override changes take effect on the next sync. Fill in **`Weapon Reaction Set`** on a weapon Blueprint to give the enemy reactions that come with what it is holding, such as a parry it can only do while carrying a sword. See [Equipping](/docs/soulslike-combat/melee-trace#equipping).
