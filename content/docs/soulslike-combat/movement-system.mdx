...
<Callout type="info">
A profile carries the fields above and nothing else. Sample count, avoidance, navmesh sampling, strafe speed and swap timing, detour, and stuck detection all live on the **Movement Evaluator** component, so they are the same for every role on that controller.
</Callout>
