...
- **Threat-Triggered Swap**: If the player stares at the AI, it swaps direction. Configured per `MovementBehaviorProfile` (requires [Threat Detection](/docs/soulslike-combat/threat-detection))
