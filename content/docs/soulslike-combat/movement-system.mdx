...
The AI holds a band around its `DesiredDistance` instead of a single exact range:
...
`DesiredDistance = 400` with `DistanceTolerance = 0.2` gives a comfort band of 320 to 480 cm. Inside the band the AI strafes; outside it, it approaches or retreats.
