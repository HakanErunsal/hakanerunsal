...
<UeSetPropertiesScene
  ...
  rows={[
    ...
    { name: "  [0] Role", value: "SEC.Role.Attacker", kind: "text", indent: true, revealAt: 2 },
    { name: "  [0] Movement Profile", value: "DA_MovementBehavior_Attacker", kind: "asset", indent: true, revealAt: 2 }
  ]}
...
<DocNav
  prev={{ title: "Attack Telegraphs", href: "/docs/soulslike-combat/attack-telegraphs" }}
  next={{ title: "Combat Tokens", href: "/docs/soulslike-combat/combat-tokens" }}
/>
