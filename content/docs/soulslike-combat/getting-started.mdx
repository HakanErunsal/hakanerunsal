...
**SoulslikeCombat** is an AI combat plugin for Unreal Engine 5.6, 5.7, and 5.8. It provides tactical enemy behavior for souls-like and action RPG games through a modular component system. Supports single-player and multiplayer (listen server and dedicated server).
...
> **Note:** This plugin requires **Unreal Engine 5.6, 5.7, or 5.8**. Older versions have incompatible StateTree APIs.
