...
**SoulslikeCombat** is a production-ready AI combat plugin for Unreal Engine 5.7. It provides intelligent, tactical enemy behavior for souls-like and action RPG games through a modular component system. The plugin supports both single-player and multiplayer (listen server and dedicated server) out of the box.
