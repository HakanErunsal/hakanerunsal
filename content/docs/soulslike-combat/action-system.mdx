...
Fill in **`Weapon Action Set`** on the weapon Blueprint. While the enemy holds that weapon it fights from that set, and releasing the weapon hands the enemy back to its AI Config. See [Equipping](/docs/soulslike-combat/melee-trace#equipping) for how the weapon reaches the enemy.
