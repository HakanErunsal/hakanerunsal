...
**Let one enemy swing at a time.** Add a **Combat Token Gate** to every melee attack, set `TokenTag = SEC.Token.Attack`, and leave the pool at 1. The rest circle until the slot frees. See [Combat Tokens](/docs/soulslike-combat/combat-tokens).
