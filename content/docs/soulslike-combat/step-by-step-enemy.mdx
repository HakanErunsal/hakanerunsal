...
Leave the config's `DefaultStateTree` empty and the native loop runs the combat you just built. Set it to `StateTree_SEC_Core`, or author your own, when you need patrol, investigation, or boss phases on top. The [StateTree Tasks](/docs/soulslike-combat/statetree) page covers the graph nodes.
