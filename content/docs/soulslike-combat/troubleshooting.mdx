...
| **Selection** is **Manual Only** | That action waits for a direct **Execute Action** call. Set Selection to Scored for a scored move. |
| **Selection** is **Chain Only** | Nothing chains into it, or the chain window has closed. Wire a chain into it from another action, or set Selection to Scored. |
