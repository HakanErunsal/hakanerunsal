...
**SoulslikeEnemyCombat** is a production-ready AI combat plugin for Unreal Engine 5.7. It provides intelligent, tactical enemy behavior for souls-like and action RPG games through a modular component system. Supports single-player, listen server, and dedicated server configurations.
